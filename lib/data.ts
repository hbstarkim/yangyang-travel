...
// 1일차 12:30 PM 점심 식당의 mapQuery → 합류 지점 정보
// (FoodSwipePicker가 localStorage에 `yangyang-food-pick:{mapQuery}`로 저장한 선택 결과와 매칭)
export const lunchMeetupSpots: Record<string, MeetupSpot> = {
  "다락막국수 양양 현남면": {
    point: "다락막국수 주차장",
    navTip:
      "카카오내비에 ‘다락막국수’ 찍고 그대로 따라가면 OK. 두 차 모두 한 번에 도착.",
    parking:
      "주차장이 길 건너편이라 가게 도착 후 가족 내릴 때 주의. 6명 한 번에 입장은 좁을 수 있어 도착 30분 전 확인 전화.",
  },
  "양양막국수 인구": {
    point: "양양막국수 인구점 주차장 (인구해변 옆)",
    navTip:
      "카카오내비에 ‘양양막국수 인구점’으로 찍기. 다락막국수보다 숙소 동선상 더 가깝습니다.",
    parking:
      "주차장이 넓어 차 2대 함께 정차 편함. 6명 동시 입장 부담 적음. 인구해변 바로 옆이라 식후 산책도 가능.",
  },
  "버거스테이지 양양 죽도": {
    point: "버거스테이지 (인구중앙길 103-2) 주차장",
    navTip:
      "카카오내비에 ‘버거스테이지 양양’. 죽도해변 코앞이라 양양IC에서 직진 동선.",
    parking:
      "가게 주차 자리는 협소할 수 있어, 인근 인구해변 공영주차장에 세우고 도보 2분이 안전. 점심 시간 한산해 6명도 OK.",
  },
  "양양 인구해변 물회": {
    point: "인구해변 공영주차장",
    navTip:
      "카카오내비에 ‘인구해변 공영주차장’. 양리단길 진입로 근처라 처남네도 찾기 쉽습니다.",
    parking:
      "공영주차장에 차 2대 세우고 양리단길 가게 도보 이동. 점심 직전 차로 물회집 위치 미리 확인 권장 (가게마다 영업 변동).",
  },
};

export const lunchMeetupFallback: MeetupSpot = {
  point: "양양IC 또는 다락막국수 주차장",
  navTip:
    "카카오내비에 합의된 가게명 입력. 12:30 PM 점심 가게를 swipe로 먼저 결정해 두시면 이 가이드가 자동 갱신됩니다.",
  parking:
    "주차장 사정은 가게마다 달라요. 식당을 결정한 뒤 다시 확인해 주세요.",
};

export const meetupTips = [
  "처남네가 30분 ~ 1시간 일찍 도착할 가능성. 도착하면 카톡으로 위치 공유.",
  "각자 출발 시점 텍스트 보내기 룰: 출발 시점, 휴게소 휴식 시점, 도착 30분 전.",
  "양양IC에서 두 차 합류해 함께 들어가는 것도 옵션 (처남네가 일찍 도착해 IC 근처 휴게소에서 대기).",
];
